...
public class SimpleShaderProgram extends ShaderProgram
{
    ...
    public SimpleShaderProgram(int numIndices,
    ...
    {
        return GLES20.glGetUniformLocation(shaderProgramHandle,
                                           OpenGLShader.projectionMatrixString);
    }
    ...
    {
        return GLES20.glGetAttribLocation(shaderProgramHandle,
                                          SimpleVertexShader.colorVectorString);
    }
